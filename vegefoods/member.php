...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(https://images.unsplash.com/photo-1544331873-011067f52ac2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80);">
          ...
          <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Local Pickups</h3>
                <span>Or delivery at a low price</span>
              </div>
            </div>      
          </div>
          <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
          ...
          <div class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Guaranteed delicious</span>
              </div>
            </div>      
          </div>
        </div>
  ...
  <div class="container">
    <div class="mb-0 ftco-animate">
      <h1 class="text-center mb-0">Request a Refund</h1>
      <p class="text-center">You may request a refund for an unsatisfactory purchase. We will review your reason and respond ASAP.</p>
    </div>
      <div class="col-md-12 heading-section ftco-animate">
        <h5 class="text-center text-success"></h5>
        <form id="contactf" action="refund.php" method="POST" class="bg-white p-5 contact-form">
          <div class="form-group">
            <input type="text" name="email" id="email" class="form-control" placeholder="Your Email">
          </div>
          <div class="form-group">
              <select name="item" id="item" class="custom-select" style="height:52px!important;">
          ...
          <div class="form-group">
            <select name="reason" id="reason" class="custom-select" style="height:52px!important;">
          ...
          <div class="form-group text-center">
            <input type="submit" name="refund" value="Send Request" class="btn btn-primary py-3 px-5">
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    $(document).ready(function() {
      $('#contactf').submit(function(e) {
        ...
        if(item == ""){
            $('#item').after('<span class="error" style="color:red">Please select an item</span>');
            e.preventDefault();
          }

        if(reason == ""){
            $('#reason').after('<span class="error" style="color:red">Please select a reason</span>');
            e.preventDefault();
          }
